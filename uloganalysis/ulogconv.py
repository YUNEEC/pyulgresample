...
def merge(pandadict, how=None, method=None, limit=None, limit_direction=None, limit_area=None):
    '''
    ...
    m.index = pd.TimedeltaIndex(m.timestamp * 1e3, unit='ns')
    m.interpolate(mehtod=method, limit=limit, inplace=True, limit_direction=limit_direction, limit_area=limit_area)
    return m
